/**
 * Reset Password Page — Set a new admin password using a valid reset token.
 */
      ...
      <div className="min-h-screen bg-[#0B1120] flex flex-col items-center justify-center px-4">
        <div className="text-center">
          ...
          <a
            ...
            className="inline-block py-2.5 px-6 bg-[#2951D5] hover:bg-[#2345b8] text-white text-sm font-medium rounded-xl transition-all"
          >
            Request New Reset
          </a>
        </div>
